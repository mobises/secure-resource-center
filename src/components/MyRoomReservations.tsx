...
import { Calendar, List, Clock, MapPin, Users, Edit, Trash2 } from "lucide-react";
import { toast } from "@/components/ui/use-toast";
import { useRoomReservations } from "@/hooks/useLocalData";
import { useAuth } from "@/hooks/useAuth";
import { format } from "date-fns";
import { es } from "date-fns/locale";

const MyRoomReservations = () => {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-2xl font-bold">Mis Reservas de Salas</h2>
      </div>
          ...
          <div className="space-y-4">
            {myReservations.length === 0 ? (
              <Card className="p-8 text-center">
                ...
                <p className="text-gray-600">No tienes reservas de salas</p>
              </Card>
            ) : (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold">{reservation.roomName}</span>
                      </div>
